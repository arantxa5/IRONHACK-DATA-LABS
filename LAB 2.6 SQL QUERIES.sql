...
SELECT first_name, last_name, address_id, email, '2', 'Tammy'
FROM customer
...
last_update)
VALUES ('2023-01-29 19:22:34', '1','130','2023-02-01 19:22:34','1','2023-01-29');
...
#comentario:para BORRAR CONSTRAINTS CON FOREIGN KEYS QUE IMPIDEN BORRAR UNA ROW EN OTRA TABLA
#ALTER TABLE payment
